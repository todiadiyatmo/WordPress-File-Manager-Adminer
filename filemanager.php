...
<div class="backRestor">
	...
	<div class="db_backResto">
		...
		<span style="font-size:1.2em;color:green;">This Directory</span>: <a class="backupa" href="javascript:alert('To bakcup this directory, then go to upper directory, and click \'ZIP\' button. It will make a backup archive');">Backup (zip)</a> | <a class="restorea" href="javascript:alert('To restore this directory (lets be glad with what I was able to do :) : \r\n1) Go to upper directory and delete this directory\r\n2) upload(upload button is in the bottom) the backup file , \r\n3) then click EXTRACT button (that button will be placed in the uploaded file\'s row, on the right side)');">Restore(from zip)</a>
	</div>
	<div class="db_backResto">
		<span style="font-size:1.2em;color:green;">DATABASE</span>: <a class="backupa" href="javascript:export_import_db('exportt');">Backup</a> | <a class="restorea"  href="javascript:export_import_db('importt');">Restore</a>
	</div>
...
<div id="footer">
  <p><?php echo $footer; ?>  [p.s. view other <a style="color:blue;" href="http://codesphpjs.blogspot.com/2014/10/must-have-wordpress-plugins.html" target="_blank">MUST-HAVE WORDPRESS PLUGINS</a>]</p>
  <?php
